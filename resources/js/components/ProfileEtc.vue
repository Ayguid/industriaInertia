<template>
    <div class="font-sans leading-tight min-h-screen bg-grey-lighter p-8">
        <div
            class="max-w-sm mx-auto bg-white rounded-lg overflow-hidden shadow-lg"
        >
            <div
                class="bg-cover h-40"
                style="
            ...
            <div class="border-b px-4 pb-6">
                <div class="text-center sm:text-left sm:flex mb-4">
                    ...
                    <div class="py-2">
                        ...
                        <div
                            class="inline-flex text-grey-dark sm:flex items-center"
                        >
                            <svg
                ...
                <div class="flex">
                    <button
                        class="flex-1 rounded-full bg-blue text-white antialiased font-bold hover:bg-blue-dark px-4 py-2 mr-2"
                    >
                        Follow
                    </button>
                    <button
                        class="flex-1 rounded-full border-2 border-grey font-semibold text-black px-4 py-2"
                    >
                        Message
                    </button>
                </div>
            ...
            <div class="px-4 py-4">
                ...
                <div class="flex">
                    <div class="flex flex-row-reverse justify-end mr-2">
                        <img
                            class="border-2 border-white rounded-full h-10 w-10"
                    ...
                    <span
                        class="flex items-center justify-center text-sm text-grey-darker font-semibold border-2 border-grey-light rounded-full h-10 w-10"
                        >+3</span
                    >
                </div>
            </div>
